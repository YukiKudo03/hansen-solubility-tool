...
![Tests](https://img.shields.io/badge/tests-2604%2B-brightgreen)
![Coverage](https://img.shields.io/badge/coverage-98.88%25-brightgreen)
![Pipelines](https://img.shields.io/badge/pipelines-90%2B-blue)
![License](https://img.shields.io/badge/license-ISC-green)
![Platform](https://img.shields.io/badge/platform-Win%20%7C%20macOS%20%7C%20Linux-lightgrey)

A production-grade desktop application for **Hansen Solubility Parameter (HSP)** based material compatibility evaluation. Supports **90+ evaluation pipelines** across 6 categories, enabling researchers and engineers to quantitatively assess solubility, adhesion, permeability, and more.

HSPに基づく材料適合性を定量評価するデスクトップアプリケーション。溶解性評価、接触角推定、膨潤度予測、ガス透過性など90以上の専門評価パイプラインを搭載。

```
┌──────────────────────────────────────────────────────────┐
│  Hansen溶解度パラメータ 溶解性評価ツール                   │
├───────────┬──────────────────────────────────────────────┤
│ 評価 (33) │  Material Group: [PP / PE / PS ...]          │
│ 選定 (26) │  Solvent:        [Toluene ▼]                │
│ 最適化(17)│  ┌─────────────────────────────────────┐    │
...
### 90+ Evaluation Pipelines across 6 Categories

| Category | Count | Description |
|----------|:-----:|-------------|
| **Evaluation** (評価) | 33 | Solubility, contact angle, swelling, chemical resistance, adhesion, ESC, gas permeability, membrane separation, coating defects, and more |
| **Selection** (選定) | 26 | Nanoparticle dispersion, dispersant, plasticizer, carrier, co-crystal screening, pigment dispersion, CNT/graphene, MXene, and more |
...
| Testing | Vitest 2.1 (2604+ tests) + Playwright 1.58 (295 E2E, 30 specs) |
| PDF | jsPDF |
...
│                   90+ evaluation engines, 10 classifiers,
...
│                   190+ IPC handlers, auto-updater, DB initialization
└── renderer/       React UI (MD3 responsive layout)
                    142 components, 79 hooks, 6-category navigation
```
...
|----------|-------------|
| **[docs/USER_MANUAL.md](docs/USER_MANUAL.md)** | User manual (Japanese) — full guide for all 90+ pipelines |
