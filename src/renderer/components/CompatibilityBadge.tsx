...
const BADGE_CONFIG: Record<string, { label: string; bg: string; text: string }> = {
  Compatible: { label: '適合', bg: 'bg-green-100', text: 'text-green-800' },
  Caution: { label: '注意', bg: 'bg-yellow-100', text: 'text-yellow-800' },
  Incompatible: { label: '不適合', bg: 'bg-red-100', text: 'text-red-800' },
};
