...
interface ElectrolyteSuitabilityBadgeProps {
  level: string;
}
...
const BADGE_CONFIG: Record<string, { label: string; bg: string; text: string }> = {
  ...
  Poor: { label: '不適', bg: 'bg-red-100', text: 'text-red-800' },
};

export default function ElectrolyteSuitabilityBadge({ level }: ElectrolyteSuitabilityBadgeProps) {
